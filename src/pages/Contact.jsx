            ...
            {contactCards.map((c) => (
              <Reveal key={c.title} delay={0.05}>
                <a
                  ...
                  className="glass-panel rounded-3xl p-6 border border-white/10 block hover:shadow-[0_0_0_1px_rgba(192,132,252,0.18)] transition-shadow"
                >
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <c.icon className="text-zinc-100 text-2xl" />
                  </div>
                </a>
              </Reveal>
            ))}
