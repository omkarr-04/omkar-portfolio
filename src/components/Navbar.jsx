        ...
        <div className="glass-card rounded-2xl px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-zinc-100 font-semibold tracking-tight hover:text-white transition-colors"
            >
              Omkar Sonawane
            </button>
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <a
              ...
              aria-label="LinkedIn"
            >
              <FaLinkedin className="text-zinc-100" />
            </a>
            <a
              className="glass-card rounded-xl p-2 hover:shadow-[0_0_0_1px_rgba(192,132,252,0.25)] transition-shadow"
          ...
          >
            <div className="glass-panel rounded-2xl px-3 py-3 mt-2">
              <div className="flex flex-col gap-1">
                {navItems.map((item) => (
                  <button
                    ...
                    className={`px-3 py-2 text-sm rounded-xl transition-colors text-left ${
                      activeSection === item.id
                        ? 'bg-white/5 text-white'
                        : 'text-zinc-300 hover:text-white hover:bg-white/5'
                    }`}
              ...
              <div className="mt-3 grid grid-cols-3 gap-2">
                <a
                  className="glass-card rounded-xl p-2 text-center hover:shadow-[0_0_0_1px_rgba(192,132,252,0.25)] transition-shadow"
                  href="https://github.com/omkar2914"
                  target="_blank"
                  rel="noreferrer"
                  aria-label="GitHub"
                >
                  <FaGithub className="inline text-zinc-100" />
                </a>
                <a
                  className="glass-card rounded-xl p-2 text-center hover:shadow-[0_0_0_1px_rgba(192,132,252,0.25)] transition-shadow"
                  href="https://www.linkedin.com/in/omkarsonawane04"
                  ...
                  aria-label="LinkedIn"
                >
                  <FaLinkedin className="inline text-zinc-100" />
                </a>
                <a
                  className="glass-card rounded-xl p-2 text-center hover:shadow-[0_0_0_1px_rgba(192,132,252,0.25)] transition-shadow"
                  href="mailto:omkarsonawane2914@outlook.com"
                  aria-label="Email"
                >
                  <FaEnvelope className="inline text-zinc-100" />
                </a>
              </div>
            </div>
          </MotionDiv>
